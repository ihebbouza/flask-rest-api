...
def create_app(db_url=None):
    ...
    app.config["JWT_SECRET_KEY"] = "103474861639513927900001110165099409736"
    jwt = JWTManager(app)

    # check blockled users => revoke tokens
    ...
    def invalid_token_callback(error):
        return (
            jsonify({"message": "Invalid token", "error": "invalid_token"}), 401
        )
